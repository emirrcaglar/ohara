    ...
    <main class="w-full max-w-md z-10">
      <div class="flex flex-col items-center mb-12">
        ...
        <h1 class="flex w-full flex-col items-center uppercase leading-none">
          <span
            class="w-full text-center text-5xl font-black tracking-[-0.07em] text-primary-container"
          >
            OHARA
          </span>
          <span
      ...
      >
        ...
        <form class="space-y-8" @submit.prevent="handleSubmit">
          ...
          <div class="pt-4 flex flex-col gap-4">
            ...
            <div
              class="flex justify-between items-center text-[12px] font-bold uppercase tracking-tighter"
            >
              <RouterLink
